...
public class TimeDriver extends Configured implements Tool {
	...
	public int run(String[] args) throws Exception {
		...
		JobConf conf = new JobConf(getConf(), TimeDriver.class);
		...
		conf.setJobName("Time Driver");
		conf.set("mbrFile", mbrFile);
		conf.setOutputKeyClass(Text.class);
		conf.setOutputValueClass(IntWritable.class);

		conf.setMapperClass(TimeJobMapper.class);
		conf.setCombinerClass(TimeJobReducer.class);
		conf.setReducerClass(TimeJobReducer.class);
	...
	public static void main(String[] args) throws Exception {
		int res = ToolRunner.run(new Configuration(), new TimeDriver(), args);
		System.exit(res);
